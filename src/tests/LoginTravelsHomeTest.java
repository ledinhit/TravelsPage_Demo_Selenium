...
// login Home page
	 ...
	 * LoginTravelsPage(driver); loginPg.LoginHomePage("user@phptravels.com", "");
	 * driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS); String
	 * passErrMes = driver.findElement(By.cssSelector(alert)).getText();
	 * System.out.println("TC_02 Email messenger error : " + passErrMes);
	 * Assert.assertEquals(passErrMes, "Invalid Email or Password");
	 * Assert.assertFalse(dashoardPg.isDisplayed());
	 * 
	 * }
	 * 
	 * @Test public void LoginWithEmailEmpty() { loginPg = new
	 * LoginTravelsPage(driver); loginPg.LoginHomePage("", "demouser");
	 * driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS); String
	 * emailErrMes = driver.findElement(By.cssSelector(alert)).getText();
	 * System.out.println("TC_03 Pass messenger error : " + emailErrMes);
	 ...
	 * LoginTravelsPage(driver); loginPg.LoginHomePage("", "");
	 * driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS); String
	 * passErrMes = driver.findElement(By.cssSelector(alert)).getText();
	 ...
	 * LoginTravelsPage(driver); loginPg.LoginHomePage("ledinh.94@gmail.com",
	 * "demouser"); driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
	 ...
	 * LoginTravelsPage(driver); loginPg.LoginHomePage("user@phptravels.com",
	 * "123456"); driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
	 * String passErrMes = driver.findElement(By.cssSelector(alert)).getText();
	 * System.out.println("TC_05 messenger error : " + passErrMes);
	 * Assert.assertEquals(passErrMes, "Invalid Email or Password");
	 * Assert.assertFalse(dashoardPg.isDisplayed()); }
	 ...
	 * LoginTravelsPage(driver); loginPg.LoginHomePage("ledinh.94gmail.com",
	 * "demouser"); driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
	 * String emailErrMes = driver.findElement(By.cssSelector(alert)).getText();
	 * System.out.println("TC_05 messenger error : " + emailErrMes);
	 * Assert.assertEquals(emailErrMes, "Invalid Email or Password");
	 * Assert.assertFalse(dashoardPg.isDisplayed()); }
	 */
}
